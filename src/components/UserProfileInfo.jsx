        ...
        <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                    ...
                    {!profileId && 
                        <button onClick={()=> setShowEdit(true)} className='flex items-center gap-2 border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0 cursor-pointer'>
                ...
                <div className='flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 mt-4'>
                    ...
                    <span className='flex items-center gap-1.5'>
                        ...
                        Joined <span>{user.createdAt ? moment(user.createdAt).fromNow() : '—'}</span>
                    </span>
                </div>
